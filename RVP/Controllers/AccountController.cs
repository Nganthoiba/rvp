    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                */
                ...
                try
                {
                    ...
                    ViewBag.message = "Password reset link has been sent to your registered email.";
                    return View("ForgotPasswordConfirmation");
                }
                catch (Exception except) {
                    ViewBag.ErrorMsg = except.GetBaseException();
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                ViewBag.message = "Please check your email, we have no account for the email.";
